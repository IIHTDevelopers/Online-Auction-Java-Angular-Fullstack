...
describe('RegistrationComponent', () => {
  ...
  describe('exception', () => {
    ...
    it('should validate the sellerName required property', () => {
    ...
    it('should validate the sellerName min-length property', () => {
      const sellerName = component.registrationForm.controls['sellerName'];
      expect(sellerName.valid).toBeFalsy();
    ...
    it('should validate the sellerName max-length property', () => {
      const sellerName = component.registrationForm.controls['sellerName'];
      expect(sellerName.valid).toBeFalsy();
    ...
    it('should validate the sellerName', () => {
      const sellerName = component.registrationForm.controls['sellerName'];
      expect(sellerName.valid).toBeFalsy();
    ...
    it('should validate the password required property', () => {
    ...
    it('should validate the password min-length property', () => {
      const password = component.registrationForm.controls['password'];
      expect(password.valid).toBeFalsy();
      password.setValue('c');
    ...
    it('should validate the password max-length property', () => {
      const password = component.registrationForm.controls['password'];
      expect(password.valid).toBeFalsy();
