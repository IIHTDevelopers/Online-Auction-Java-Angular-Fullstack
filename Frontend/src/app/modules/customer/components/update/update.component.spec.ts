...
describe('UpdateComponent', () => {
  ...
  describe('exception', () => {
    ...
    it('should validate the username required property', () => {
    ...
    it('should validate the username min-length property', () => {
      const username = component.updateForm.controls['username'];
      expect(username.valid).toBeFalsy();
      username.setValue('c');
    ...
    it('should validate the username max-length property', () => {
      const username = component.updateForm.controls['username'];
      expect(username.valid).toBeFalsy();
